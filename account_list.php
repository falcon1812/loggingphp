    ...
    ?>
        <?php foreach ($result as $user): ?>
                <tr>
                    ...
                    <td style="text-align: center"><?= htmlspecialchars($user['gender']) ?></td>
                    <td style="text-align: center"><?= htmlspecialchars($user['isAdmin']) ?></td>
                    <td style="text-align: center"><a href="update.php?id=<?= htmlspecialchars($user['id']) ?>">EDIT</a><br><a href="" data-toggle="modal" data-target="#delete_modal">DELETE</a></td>
                </tr>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                You are going to delete <?= htmlspecialchars($user['username']) ?> ?
                            </div>
                            <div class="modal-footer">
                                <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="button" id="delete_acc" name="delete" value="delete" data-id="<?= htmlspecialchars($user['id']) ?>" class="btn btn-danger">Delete</button>
                            </div>
                        </div>
                    </div>
                </div>
